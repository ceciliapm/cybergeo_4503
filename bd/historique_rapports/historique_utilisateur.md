...
L’objectif est ici de vider l’historique des rapports générés de la plateforme tout en les sauvegardant dans une table annexe (prod.resultats_histo_backup) de la BD xxxxx. 
*1/ Se connecter à la BDD xxxxx
```
su postgres
psql -d xxxxx  # -d pour le nom de la BD à connecter)
```
