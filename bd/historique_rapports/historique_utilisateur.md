# Réinitialisation de l’historique utilisateur
L’objectif est ici de vider l’historique des rapports générés de la plate-forme tout en les sauvegardant dans une table annexe (prod.resultats_histo_backup) de la BDD PAMPAS. 
